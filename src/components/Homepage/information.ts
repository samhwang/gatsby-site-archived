export const experiences = [
  {
    ...
    description: [],
    techIcons: ['js', 'react', 'node', 'npm', 'yarn', 'php', 'wordpress', 'html5', 'css3', 'sass', 'aws', 'docker', 'github'],
    technologies: [
      'PHP 7 and Wordpress',
      ...
      'CI/CD: GitHub Actions pipeline and GitHub packages registry'
    ],
  },
  {
    ...
    techIcons: ['php', 'js', 'bootstrap', 'css3', 'less', 'sass', 'docker', 'gitlab'],
    technologies: [
  ...
  },
  {
    ...
    techIcons: ['php', 'wordpress', 'bootstrap', 'html5', 'css3', 'js', 'paypal'],
    technologies: [
